...
public interface SummaryRepository extends JpaRepository<Summary, Long> {
    ...
    @Query("SELECT s FROM Summary s WHERE s.subjectId = :subjectId AND DATE(s.createdAt) = :createdDate")
    Optional<Summary> findBySubjectIdAndCreatedDate(@Param("subjectId") Long subjectId,
